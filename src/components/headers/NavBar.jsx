            ...
            <div className='lg:w-[95%] mx-auto sm:px-6 lg:px-6'>
                <div className='px-4 py-4 flex items-center justify-between'>
                    ...
                    <div onClick={() => navigate('/')} className=" flex-shrink-0 cursor-pointer pl-7 md:p-0 flex items-center">
                        <div>
                        <h1 className={`text-2xl inline-flex gap-3 items-center font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>
                            YogaMaster 
                            <img src="yoga-logo.png" alt="" className='w-8 h-8' />
                        </h1>
                        <p className={`font-bold text-[13px] tracking-[8px] ${isDarkMode ? 'text-white' : 'text-black'}`}>Quick Explore</p>
                        </div>
                    </div>
