    ...
    <div className='md:w-[80%] mx-auto my-36'>
        <div>
            ...
            <div className='w-[40%] text-center mx-auto my-4'>
                <p className='text-gray-500'><b>Dive into Our Most Loved Classes! </b>Discover why these sessions are a hit among our students with their soaring enrollments.</p>
            </div>
        </div>
