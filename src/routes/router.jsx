...
import ApprovedCourse from "../pages/Dashboard/Instructors/ApprovedCourse";
...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                path: "class/:id",
                element: <SingleClass/>,
                loader: ({ params }) => fetch(`https://yoga-server-4.onrender.com/class/${params.id}`),
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://yoga-server-4.onrender.com/users/${params.id}`),
            },
            {
                path: 'admin-home',
